...
return [
    ...
    */
    ...
    'menu' => [
        ...
        */
        [
            'header' => 'DASHBOARD DE CONTROL',
        ],
        [
            'text' => 'PANEL PRINCIPAL',
            'route' => 'admin.home',
            'icon' => 'fas fa-fw fa-tachometer-alt', // Icono de dashboard de Font Awesome
            'icon_color' => 'cyan',
        ],
        [
            'header' => 'USUARIOS',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'LISTA DE ENCARGADOS/CAMIONES',
                    'icon_color' => 'yellow',
                    'icon' => 'fas fa-fw fa-users',
                    'route' => 'admin.encargadotrucks.index',
                    'can' => 'admin.encargadotrucks.index',
                ],
                [
                    'text' => 'AGREGAR ENCARGADO',
                    'icon' => 'far fa-fw fa-file-alt',
                    'route' => 'admin.encargadotrucks.create',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'route' => 'admin.predicciones.pmv1',
                ],
                [
                    'text' => 'PMV2',
                    'icon_color' => 'cyan',
                    'icon' => 'fas fa-fw fa-brain',
                    'route' => 'admin.predicciones.pmv2',
                ],
                [
                    'text' => 'PMV3',
                    'icon_color' => 'cyan',
                    'icon' => 'fas fa-fw fa-brain',
                    'route' => 'admin.predicciones.pmv3',
                ],
            ],
        ],
        /*
